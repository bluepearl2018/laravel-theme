...
<div class="fixed inset-0 flex z-40 lg:hidden" role="dialog" aria-modal="true">
	<div x-transition:enter="transition-opacity ease-linear duration-300"
		 ...
		 id="mobile-canvas" x-show="mobileMenu" class="fixed inset-0 bg-gray-600 bg-opacity-75" aria-hidden="true"></div>

	<div x-transition:enter="ease-in duration-300 transform"
		 x-transition:enter-start="-translate-x-full"
		 x-transition:enter-end="translate-x-0"
		 x-transition:leave="ease-out duration-300 transform"
		...
		<div
				...
				x-transition:leave-start="opacity-100"
				x-transition:leave-end="opacity-0"
				class="absolute top-0 right-0 -mr-12 pt-16">
			<button type="button"
